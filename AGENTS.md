...
This project is indexed by GitNexus as **madkrapow** (1006 symbols, 2149 relationships, 73 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
