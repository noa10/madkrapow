...
This project is indexed by GitNexus as **madkrapow** (1811 symbols, 3610 relationships, 135 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
