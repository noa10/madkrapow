...
This project is indexed by GitNexus as **madkrapow** (608 symbols, 1122 relationships, 27 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
