...
This project is indexed by GitNexus as **madkrapow** (718 symbols, 1389 relationships, 33 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
