...
This project is indexed by GitNexus as **madkrapow** (5371 symbols, 8947 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
