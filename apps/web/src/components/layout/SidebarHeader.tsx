      ...
      <div className="flex h-14 items-center justify-between px-3">
        ...
        <Tooltip content="Collapse sidebar" side="bottom">
          <button
            ...
            className="inline-flex items-center justify-center rounded p-1.5 text-muted-foreground transition hover:bg-white/10 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/50"
          >
