...
if (process.env.SKIP_ENV_VALIDATION === 'true') {
  env = {
    ...
    LALAMOVE_BASE_URL: undefined,
    LALAMOVE_MARKET: 'MY',
    LALAMOVE_CITY_NAME: 'Shah Alam',
    LALAMOVE_WEBHOOK_URL: undefined,
    LALAMOVE_ENABLED: true,
    LALAMOVE_DEFAULT_STANDARD_SERVICE_TYPE: 'MOTORCYCLE',
    LALAMOVE_DEFAULT_BULK_SERVICE_TYPE: 'CAR',
    LALAMOVE_POLLING_INTERVAL_MS: 30000,
    HUBBOPOS_ENABLED: false,
    HUBBOPOS_API_BASE_URL: undefined,
    HUBBOPOS_CLIENT_ID: undefined,
    HUBBOPOS_CLIENT_SECRET: undefined,
    HUBBOPOS_SCOPE: 'mexpos.partner_api',
    HUBBOPOS_MERCHANT_ID: undefined,
    HUBBOPOS_LOCATION_ID: undefined,
    HUBBOPOS_SYNC_INTERVAL_MINUTES: 5,
    HUBBOPOS_REQUEST_TIMEOUT_MS: 10000,
    HUBBOPOS_MAX_RETRIES: 3,
    HUBBOPOS_CIRCUIT_BREAKER_THRESHOLD: 5,
    HUBBOPOS_CIRCUIT_BREAKER_RESET_MS: 60000,
  ...
  const envData = {
    ...
    HUBBOPOS_SYNC_INTERVAL_MINUTES: process.env.HUBBOPOS_SYNC_INTERVAL_MINUTES,
